    ...
    <div class="dashboard-wrapper">
        <div class="dashboard-ecommerce">
            <div class="container-fluid dashboard-content ">
                ...
                <!-- pageheader  -->
                <!-- ============================================================== -->
                <header-content title="E-commerce Dashboard Template Toyib"></header-content>
                <!-- ============================================================== -->
                <!-- end pageheader  -->
                <!-- ============================================================== -->
                <div class="ecommerce-widget">
                    ...
                    <div class="row">
                        <card-widget title="Total Revenue" value="12099" value-type="CURRENCY"></card-widget>
                        <card-widget title="Affiliate Revenue" value="12099" value-type="CURRENCY"></card-widget>
                        <card-widget title="Refunds" value="0.00"></card-widget>
                        <card-widget title="Avg. Revenue Per User"  value="28000"></card-widget>
                    </div>
                    <div class="row">
                        <!-- ============================================================== -->
...
<script>
    import FooterContent from "@/components/main/content/FooterContent";
    ...
    export default {
        name: "Dashboard",
        components: {RevenueGraph, CardWidget, HeaderContent, FooterContent},
    }
</script>
